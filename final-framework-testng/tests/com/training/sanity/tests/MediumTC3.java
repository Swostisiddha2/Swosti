...
import com.training.pom.SaleinvoicePOM;
import com.training.utility.DriverFactory;
import com.training.utility.DriverNames;

public class MediumTC3 {
	...
	private SaleinvoicePOM saleinvoicePOM;
	...
	public void setUp() throws Exception {
		...
		saleinvoicePOM = new SaleinvoicePOM(driver);
	...
	public void validLoginTest() throws InterruptedException {
		...
		saleinvoicePOM.saleicon();
		//saleinvoicePOM.salesClick();
		saleinvoicePOM.order();
		saleinvoicePOM.view();
		saleinvoicePOM.invoice();
		}
